                ...
                >
                    ...
                    <div style={{display: "flex", gap: "10px", flex: 1, flexWrap: "nowrap", overflow: "hidden"}}>
                        ...
                        {userSession && checkRoles(userSession.roles, [RoleEnum.ROLE_ADMIN]) && (
                                <>
                                    <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" items={adminMenuItems}
                                          key={"adminMenu"}
                                          style={{width: "fit-content", whiteSpace: "nowrap", minWidth: "140px"}}/>
                                    <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" items={pageManagementMenuItems}
                                          key={"pageMenu"}
                                          style={{width: "fit-content", whiteSpace: "nowrap", minWidth: "180px"}}/>
                                </>
                        )}
                        {userSession && (
                                <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" items={diveEventMenuItems}
                                      key={"diveEventMenu"}
                                      style={{width: "fit-content", whiteSpace: "nowrap", minWidth: "160px"}}/>
                        )}
                        {pageMenus.length > 0 &&
                    ...
                    <div style={{display: "flex", gap: "10px", alignItems: "center", whiteSpace: "nowrap"}}>
                        <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" items={languageMenuItems}
                              key={"languageMenu"}
                        ...
                        {!userSession && (
                                <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" items={registerMenuItems}
                                      key={"registerMenu"}
                                      style={{width: "fit-content", whiteSpace: "nowrap", minWidth: "140px"}}/>
                        )}
                    </div>
