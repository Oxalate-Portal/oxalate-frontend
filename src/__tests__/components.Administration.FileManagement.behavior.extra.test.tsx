...
describe("Administration pages", () => {
    ...
    it("covers file column renderers, upload callbacks, deletion and status colours", async () => {
        api["fileTransferAPI.findAllDiveFiles"].mockResolvedValue([
            {id: 1, eventId: 10, diveGroupId: 20, status: "UPLOADED", filename: "dive.pdf", filesize: 2048, creator: "a", createdAt: "2026-01-01", url: "/dive"}
        ]);
        api["fileTransferAPI.findAllDocuments"].mockResolvedValue([
            {id: 2, status: "PUBLISHED", filename: "doc.pdf", filesize: 1024, creator: "b", createdAt: "2026-01-02", url: "/doc"}
        ]);
        api["fileTransferAPI.findAllPageFiles"].mockResolvedValue([
            {id: 3, pageId: 30, language: "en", status: "UPLOADED", filename: "one", filesize: 1024, creator: "c", createdAt: "2026-01-03", url: "/one"},
            {id: 4, pageId: 31, language: "fi", status: "PUBLISHED", filename: "two", filesize: 2048, creator: "d", createdAt: "2026-01-04", url: "/two"},
            {id: 5, pageId: 32, language: "sv", status: "DELETED", filename: "three", filesize: 3072, creator: "e", createdAt: "2026-01-05", url: "/three"}
        ]);
